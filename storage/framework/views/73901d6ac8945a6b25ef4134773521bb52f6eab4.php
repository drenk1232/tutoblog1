<header class="topbar" data-navbarbg="skin5">
          ...
          <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="index.html">
              ...
              <b class="logo-icon ps-2">
                ...
                <!-- Dark Logo icon -->
                <img
                  src="<?php echo e(asset("assets/back/images/logo-icon.png")); ?>"
                  alt="homepage"
                  class="light-logo"
                  width="25"
                />
              ...
              <span class="logo-text ms-2">
                <!-- dark Logo text -->
                <img
                  src="<?php echo e(asset("assets/back/images/logo-text.png")); ?>"
                  alt="homepage"
                  class="light-logo"
                />
              </span>
          ...
          >
            ...
            <ul class="navbar-nav float-end">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <img
                    src="<?php echo e(asset("assets/back/images/users/1.jpg")); ?>"
                    alt="user"
      ...
      </header><?php /**PATH C:\laragon\www\tutoblog\resources\views/theme/back/top_header.blade.php ENDPATH**/ ?>